...
from settings import BOOTSTRAP_SERVERS, CONSUME_TOPIC_RIDES
...
# query1 = running_totals.writeStream \
#     .format("parquet") \
#     .option("path", "/opt/stream/output_csv") \
#     .option("checkpointLocation", "/opt/stream/output_checkpoint") \
#     .option("header", "true") \
#     .start()
